...
${PROJ_DIR}/Debug/main -f ${PROJ_DIR}/test/bm23.mps -d 0 --strengthen=1 --gomory=-1 --optfile=${VPC_DIR}/data/ip_obj.csv --disj_options="2:4:8:16:32:64" --analyze_regularity=1 --mode=4 --cutlimit=-1 --temp=40 -v 0 $1 $2 $3 $4 $5 $6 $7 $8
