...
void CglAdvCut::generateCuts(const OsiSolverInterface& si, OsiCuts& cuts, const CglTreeInfo info) {
  ...
  vpc_params.set(VPCParametersNamespace::AWAY, this->params.get(AWAY));
  ...
  vpc_params.set(VPCParametersNamespace::MAX_NUM_HOT_START_VIOL, this->params.get(StrengtheningParameters::MAX_NUM_HOT_START_VIOL));
