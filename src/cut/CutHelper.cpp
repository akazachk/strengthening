...
#include "CglAdvCut.hpp" // For FailureType
...
int cleanCut(OsiRowCut* const cut, const OsiSolverInterface* const solver,
    const Parameters& params, const double min_abs_coeff,
