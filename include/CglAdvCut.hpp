...
// Project files
#include "Parameters.hpp" // SolverInterface and Parameters
...
public:
  ...
  /** Param constructor */
  CglAdvCut(const Parameters& param);
  ...
  void setParams(const Parameters& param);
...
protected:
  ...
  void initialize(const CglAdvCut* const source = NULL, const Parameters* const param = NULL);
